...
C_SRCS += \
../code/Kalman/Kalman_Filter.c 

OBJS += \
./code/Kalman/Kalman_Filter.o 

COMPILED_SRCS += \
./code/Kalman/Kalman_Filter.src 

C_DEPS += \
./code/Kalman/Kalman_Filter.d 


# Each subdirectory must supply rules for building sources it contributes
code/Kalman/%.src: ../code/Kalman/%.c code/Kalman/subdir.mk
	@echo '正在构建文件： $<'
...
code/Kalman/%.o: ./code/Kalman/%.src code/Kalman/subdir.mk
	@echo '正在构建文件： $<'
